    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message ||
            errorData.error ||
            "Failed to redeem voucher. Please check if the voucher is valid and not already used."
        );
      }
      ...
      setErrorMessage(
        error instanceof Error ? error.message : "Failed to process voucher"
      );
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-pink-transparent/10 to-purple-600/10 p-4 rounded-lg border border-pink-DEFAULT/20">
              <p className="text-gray-300">
                Enter your TrueMoney Wallet Gift voucher link below to add funds to
                your account.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-gray-400">
                Example: https://gift.truemoney.com/campaign/?v=xxxxxxxxxx
              </p>
            </div>
